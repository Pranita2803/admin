...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update delivery set username='$_POST[uname]', f_name='$_POST[fname]', l_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',password='".md5($_POST[$password])."',address='$_POST[address]' where del_id='$_GET[del_upd]' ";
	mysqli_query($db, $mql);
			$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>delivery boy Updated!</strong></div>';
...
//echo var_dump($_POST);
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Update deliveryboy</h4>
                            </div>
                            <div class="card-body">
							  <?php $ssql ="select * from delivery where del_id='$_GET[del_upd]'";
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                             ...
                                             your current address  
                                                    ...
                                                    <textarea name="address" type="text" style="height:100px;" class="form-control form-control-danger"<?php  echo $newrow['address'];  ?>" placeholder="your address">
