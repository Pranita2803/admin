        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse m-4" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0 pe-4 h6">
                    ...
                    <a href="add_menu.php" class="nav-item nav-link">Restaurant</a>
                    <a href="/FOODEE-MAIN/about.php" class="nav-item nav-link">About</a>
                    <a href="/FOODEE-MAIN/contact.php" class="nav-item nav-link">Contact</a>
                    <!-- <a href="signin.php" class="nav-item nav-link">SignIn</a> -->
               
                <!-- <a href="register.php" class="btn btn-primary py-2 px-4">SignUp</a> -->
            </div>
            <?php
if(!empty($_SESSION["s_id"])) // if user is not login
{

                              echo ' <a href="register.php" class="nav-item nav-link">Signin</a>
                              <a href="singup.php" class="btn btn-primary py-2 px-4">Signup</a>';
                             
}
else
{

                                    echo ' <a href="view_order.php" class="nav-item nav-link  active">View Order</a>
                                    <a href="view_delivery.php" class="nav-item nav-link  active">view Delivery boy </a>
...
?>
   ...
   <div class="row">
    <div class="col-md-6">
        <div class="image">
            <img src= "..\admin\Res_img\5ad74b60c13bb" class="m-4 p-4">     
    ...
    <div class="col-md-6">
        ...
        <div class="">
            <a href="location.php" class="text-decoraton-none btn btn-primary radius-pill" id="btnn">restaurant loction</a>
            <a href="signup.php" class="text-decoraton-none btn btn-primary radius-pill" id="btnn">login</a>
