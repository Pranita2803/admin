...
if(isset($_POST['submit'] ))
{
	...
	$check_username= mysqli_query($db, "SELECT username FROM delivery where username = '".$_POST['uname']."' ");
	$check_email = mysqli_query($db, "SELECT email FROM delivery where email = '".$_POST['email']."' ");
	...
	$mql = "INSERT INTO delivery (username,f_name,l_name,email,phone,password,address) VALUES('".$_POST['uname']."','".$_POST['fname']."','".$_POST['lname']."','".$_POST['email']."','".$_POST['phone']."','".md5($_POST['password'])."','".$_POST['address']."')";
	// mysqli_query($db, $mql);
			// $success = 	'<div class="alert alert-success alert-dismissible fade show">
																// <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																// <strong>Congrass!</strong> New delivery boy Added Successfully.</br></div>';
    ...
    echo "ERROR: Could not able to execute $mql. " . mysqli_error($db);
 }
    }
    }
}
										 ...
										 <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control form-control-danger" pattern="[1-9]{1}[0-9]{9}" maxlength="10" placeholder="phone">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
